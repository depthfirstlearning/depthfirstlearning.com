...
Thank you to Avital Oliver, Nic Ford, Ethan Holly, Matthew Johnson, John Schulman, George Tucker, and Charles Weill for contributing to this guide.
...
# 1 Policy Gradient
  **Motivation**: Policy gradient methods (e.g. TRPO) are a class
  ...
  <a href="https://colab.research.google.com/drive/1KFQ-NvcYHL0Pi9TUM96iTEGZzt9GLffO" class="colab-root">Reproduce in a <span>Notebook</span></a>
