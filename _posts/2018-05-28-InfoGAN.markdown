...
<iframe class="deps" src="/assets/infogan-deps.svg" width="200" >
</iframe>

<!--
<img src="/assets/infogan-deps.svg" style="width: 200px; height: auto; float: right; margin-left: 40px; margin-bottom: 30px;" />
-->
