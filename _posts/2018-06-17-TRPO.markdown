...
# 6 The Paper
  ...
  **Questions**:
  ...
  4. In practice, TRPO is really slow. What is the main computational
    bottleneck and how might we remove it? Can we approximate this bottleneck?
  5. TRPO makes a series of approximations that deviate from the policy
  ...
  6. TRPO is a general procedure to directly optimize parameters from rewards,
