...
# 5 Trust Region Methods
  ...
  **Optional Readings**:
  1. Numerical Optimization by Nocedal, Wright: Chapter 4, Section 4.3
...
# 6 The Paper
  ...
  **Questions**:
  1. How is the trust region set in TRPO? Can we do better? Is it worth it?
  ...
  4. What are the pros and cons of using the vine and single-path methods?
  5. In practice, TRPO is really slow. What is the main computational
    bottleneck and how might we remove it? Can we approximate this bottleneck?
  6. TRPO makes a series of approximations that deviate from the policy
  ...
  7. TRPO is a general procedure to directly optimize parameters from rewards,
