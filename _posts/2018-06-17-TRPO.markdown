...
(Thank you to Avital Oliver, Matthew Johnson and George Tucker for contributing to this guide.)
...
# 4 Conjugate Gradient
  ...
  **Questions**:
  1. Explain in detail how one could use the conjugate gradient method to
     compute an approximation of the inverse of the Fisher information matrix
     for a model.
     <details><summary>Hint</summary>
